...
PageCache.prototype.getFile = function(url, cb) {
  var self = this;
  // Begin database transaction
  var transaction = this._db.transaction([PageCache.FILESTORE_NAME]);
  var objectStore = transaction.objectStore(PageCache.FILESTORE_NAME);
...
PageCache.prototype.writeFile = function(url, data) {
  var transaction = this._db.transaction([PageCache.FILESTORE_NAME], "readwrite");
  var objectStore = transaction.objectStore(PageCache.FILESTORE_NAME);
...
// =======
// **removeFile ( url )**
PageCache.prototype.removeFile = function(url) {
  var transaction = this._db.transaction([PageCache.FILESTORE_NAME], "readwrite");
  var objectStore = transaction.objectStore(PageCache.FILESTORE_NAME)
